...
namespace ProjectEuler.Tests.Problems
{
    ...
    public class ProblemsTests
    {
        ...
        {
            Assert.AreEqual(142857, new Problem052().Run());
        }

        [TestMethod]
        public void Problem053()
        {
            Assert.AreEqual(4075, new Problem053().Run());
        }
        ...
        {
            Assert.AreEqual(190569291, new Problem076().Run());
        }
        ...
        {
            Assert.AreEqual(427337, new Problem081().Run());
        }
        ...
        {
            Assert.AreEqual(2906969179L, new Problem125().Run());
        }

        [TestMethod]
        public void Problem145()
        {
            Assert.AreEqual(608720, new Problem145().Run());
        }
        ...
        {
            Assert.AreEqual(18946051, new Problem251().Run());
        }
    }
}